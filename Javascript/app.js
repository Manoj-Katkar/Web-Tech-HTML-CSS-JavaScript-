// ^here it will get display in the console
// console.log("Hello Js I am learning to you that How to Implement");
// console.log('KKR are won the IPL');
...
// ^ Declaring the variables in the Javascript 
...
var character = 'a';
console.log(character + 32);

console.log(num);

// ! doubt I not understood the type error ask it to the sir 
